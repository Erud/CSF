...
.EXAMPLE
    ...
    .\Get-CMDeviceModels.ps1 -SiteServer "psccm-app-01.csfunds.org"
...
#    $BIOSversion = Get-WmiObject -Namespace "root\SMS\site_$($SiteCode)" -Class SMS_G_System_PC_BIOS -ComputerName $SiteServer | Select-Object -Property SMBIOSBIOSVersion
